...
public enum EnumProductStatus {
    ...
    EnumProductStatus(int code, String msg) {
      this.code = code;
      this.msg = msg;
      this.display = true;
    }
     ...
     * @return  枚举对象
     */
    public static EnumProductStatus getEnumByCode(int code) {
      for (EnumProductStatus type : values()) {
    ...
    public static Map<Integer, String> toMap() {
      ...
      for (EnumProductStatus type : EnumProductStatus.values()) {
